...
//import ammonite.compiler.iface.{CodeWrapper, CompilerBuilder, CompilerLifecycleManager, Parser, Preprocessor}
//import ammonite.interp.{DependencyLoader, PredefInitialization, Watchable}
...
// */
//
//class Session1(val compilerBuilder: CompilerBuilder,
